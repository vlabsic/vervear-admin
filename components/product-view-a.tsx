...
export default function ProductViewA() {
  ...
  // Add state for settings modal and UI settings
  ...
  const [uiSettings, setUISettings] = useState<UISettings>({
    ...
    show360View: true,
    showTryOnView: true,
    viewerBackgroundColor: "#FFFFFF", // Changed to white
  })
    ...
    <>
      ...
      {isMobile ? (
            ...
            <div className="flex justify-between items-start">
              <div>
                {selectedProduct ? (
                  <>
                    <h1
                      className="text-[24px] font-semibold text-[#000000] mb-1"
                ...
                {products.map((product, index) => {
                  ...
                  if (product) {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-full h-full bg-[#FFFFFF] overflow-hidden flex items-center justify-center`}
                          style={{
        ...
        <div className="flex flex-row w-full min-h-screen bg-[#ffffff]" style={{ fontFamily: "Sohne, sans-serif" }}>
          ...
          <div
            className="w-2/5 p-8 flex flex-col"
            style={{ fontFamily: "Sohne, sans-serif", backgroundColor: "#F5F5F5" }}
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                {selectedProduct ? (
                  <>
                    <h1
                      className="text-4xl font-semibold text-[#000000] mb-2"
                      style={{ fontFamily: "Sohne, sans-serif" }}
                    >
                      {selectedProduct.name}
                    </h1>
              ...
              {products.map((product, index) => {
                ...
                if (product) {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`aspect-square bg-[#FFFFFF] overflow-hidden flex items-center justify-center`}
                        style={{
                          borderRadius: `${uiSettings.productCornerRadius}px`,
                          ...(isSelected
                            ? {
